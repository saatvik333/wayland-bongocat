...
make clean          # Remove build artifacts and generated protocols
...
make protocols      # Regenerate Wayland protocol bindings
...
| `protocols/` | Wayland XML specs + generated C bindings (regenerated by `make protocols`) |
